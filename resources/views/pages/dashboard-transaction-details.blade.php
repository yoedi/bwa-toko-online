                    ...
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">{{ App\Models\Province::find($transaction->transaction->user->province_id)->name }}</div>
                        </div>
                        <div class="col-12 col-md-6">
                          <div class="product-title">City</div>
                          <div class="product-subtitle">{{ App\Models\Regency::find($transaction->transaction->user->regency_id)->name }}</div>
                        </div>
                        <div class="col-12 col-md-6">
...
@push('addon-script')
  ...
  <script>
    var transactionDetails = new Vue({
      ...
      data: { status: "{{ $transaction->shipping_status }}", 
